...
type LiveRequest = {
  ...
  operation: "company_check" | "bank_ledgers" | "ledger_masters" | "local_ledger_catalogue" | "verify_bank_transaction" | "match_bank_statement" | "fetch_customer_open_bills" | "scan" | "create_debit_note";
