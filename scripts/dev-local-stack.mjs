...
const serviceDefinitions = [
  ["frontend", "npm run dev --workspace @gajkesari/web"],
  ["api", "npm run dev --workspace @gajkesari/api"],
  ["worker", "npm run worker:local --workspace @gajkesari/api"],
  ["tally-live-gateway", "npm run dev --workspace @gajkesari/tally-live-gateway", 3002],
];
...
console.log("Gajkesari local stack starting: frontend :3000, API :3001, Tally live gateway :3002, and worker.");
